...
def mergeInfoSampleScheduleReport():
    ...
    for indice, fila in df.iterrows():
        ...
        if os.path.exists(ruta_imagen):
            ...
            hoja_copia.add_image(img, "D100")  # Cambia la celda si es necesario

        # Guarda el archivo de Excel en la carpeta de salida
        nombre_archivo_salida = f"Archivo_{indice + 1}.xlsx"
